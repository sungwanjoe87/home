    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_createdate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 20, 35, 25, 121515))),
                ('f_updatedate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 20, 35, 25, 121515))),
